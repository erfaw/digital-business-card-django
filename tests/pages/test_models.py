...
class TestBusinessCardModel:
    ...
    def test_linkedin_field_blank_true(self, business_card_factory):
        obj = business_card_factory()
        obj.full_clean()
        assert obj.linkedin == ""
    ...
    def test_linkedin_preview_field_blank_true(self, business_card_factory):
        obj = business_card_factory()
        obj.full_clean()
    ...
    def test_response_time_field_blank_true(self, business_card_factory):
        obj = business_card_factory()
        obj.full_clean()
