...
class TestRegisterForm:
    ...
    def test_full_name_field_min_length(self):
        MIN_LEN = 3
        td = self.test_data.copy()
    ...
    def test_password_and_password2_being_equal(self):
        td = self.test_data.copy()
        td["password"] = "1"*8
        td["password"] = "1"*9
        form = RegisterForm(td)
    ...
    def test_username_validation(self, user_factory):
    ...
    def test_email_validation(self, user_factory):
